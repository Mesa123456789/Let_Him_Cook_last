...
namespace Let_Him_Cook_last.Screen
{
    public class GameplayScreen : screen
    {
        ...
        static Vector2 playerPos = new Vector2(750,440);
        ...
        int rotationMenuBG;
        bool FinsihCooking;
        public static RectangleF Bounds = new RectangleF(new Vector2((int)playerPos.X, (int)playerPos.Y), new Vector2(40, 60));
